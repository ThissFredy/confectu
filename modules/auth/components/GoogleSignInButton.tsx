...
function SubmitButton() {
  ...
  return (
    <button
      ...
      className="flex h-12 min-h-[44px] w-full items-center justify-center gap-3 rounded-lg border border-zinc-300 bg-white px-6 text-base font-medium text-zinc-900 shadow-sm transition-colors hover:bg-zinc-50 disabled:cursor-not-allowed disabled:opacity-60 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100 dark:hover:bg-zinc-800"
    >
      {pending ? (
        "Redirigiendo..."
      ) : (
